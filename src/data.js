...
export const ingredients = [
  ...
  { id: 'chilli', name: 'Red chilli', localName: 'Cili merah', icon: '*', category: 'Produce', defaultUnit: 'pieces' },
  ...
  { id: 'dark-soy-sauce', name: 'Dark soy sauce', localName: 'Kicap hitam', icon: '*', category: 'Pantry', defaultUnit: 'millilitres' },
...
export const recipes = [
  recipe({
    ...
    ingredients: [
      { ingredientId: 'basmati-rice', quantity: 300, unit: 'grams' },
      { ingredientId: 'coconut-milk', quantity: 250, unit: 'millilitres' },
      { ingredientId: 'water', quantity: 250, unit: 'millilitres' },
      { ingredientId: 'ikan-bilis', quantity: 60, unit: 'grams' },
      { ingredientId: 'egg', quantity: 2, unit: 'pieces' },
      { ingredientId: 'cucumber', quantity: 1, unit: 'pieces' },
      { ingredientId: 'chilli', quantity: 3, unit: 'pieces' },
      { ingredientId: 'shallot', quantity: 4, unit: 'pieces' },
      { ingredientId: 'cooking-oil', quantity: 45, unit: 'millilitres' },
  ...
  recipe({
    ...
    localName: 'Nasi Goreng Kampung',
    timeMinutes: 25,
    difficulty: 'easy',
    mealType: 'dinner',
    dietaryTags: ['halal', 'no-pork'],
    ingredients: [
      { ingredientId: 'cooked-rice', quantity: 500, unit: 'grams' },
      { ingredientId: 'egg', quantity: 2, unit: 'pieces' },
      { ingredientId: 'ikan-bilis', quantity: 35, unit: 'grams' },
      { ingredientId: 'chilli', quantity: 3, unit: 'pieces' },
      { ingredientId: 'garlic', quantity: 3, unit: 'cloves' },
      { ingredientId: 'shallot', quantity: 3, unit: 'pieces' },
      { ingredientId: 'green-beans', quantity: 100, unit: 'grams' },
      { ingredientId: 'soy-sauce', quantity: 15, unit: 'millilitres' },
      { ingredientId: 'cooking-oil', quantity: 30, unit: 'millilitres' },
    ],
  ...
  recipe({
    ...
    localName: 'Nasi Telur Tomato',
    timeMinutes: 20,
    difficulty: 'easy',
    mealType: 'lunch',
    dietaryTags: ['halal', 'vegetarian', 'no-pork', 'no-seafood'],
    ingredients: [
      { ingredientId: 'cooked-rice', quantity: 400, unit: 'grams' },
      { ingredientId: 'egg', quantity: 3, unit: 'pieces' },
      { ingredientId: 'tomato', quantity: 3, unit: 'pieces' },
      { ingredientId: 'spring-onion', quantity: 2, unit: 'stalks' },
      { ingredientId: 'garlic', quantity: 2, unit: 'cloves' },
      { ingredientId: 'cooking-oil', quantity: 30, unit: 'millilitres' },
      { ingredientId: 'salt', quantity: 4, unit: 'grams' },
      { ingredientId: 'sugar', quantity: 3, unit: 'grams' },
    ],
    steps: ['Beat eggs with half the salt and set aside.', 'Saute garlic in oil, add chopped tomatoes and cook until soft.', 'Season tomatoes with remaining salt and sugar.', 'Pour in eggs and gently fold until softly set.', 'Spoon over hot rice and finish with sliced spring onion.'] }),
  recipe({
    id: 'chicken-teriyaki-rice',
    name: 'Chicken Teriyaki Rice',
    localName: 'Nasi Ayam Teriyaki',
    timeMinutes: 30,
    difficulty: 'easy',
    mealType: 'dinner',
    dietaryTags: ['halal', 'no-pork', 'no-seafood'],
    ingredients: [
      { ingredientId: 'cooked-rice', quantity: 400, unit: 'grams' },
      { ingredientId: 'chicken-thigh', quantity: 400, unit: 'grams' },
      { ingredientId: 'teriyaki-sauce', quantity: 90, unit: 'millilitres' },
      { ingredientId: 'garlic', quantity: 2, unit: 'cloves' },
      { ingredientId: 'ginger', quantity: 15, unit: 'grams' },
      { ingredientId: 'cooking-oil', quantity: 15, unit: 'millilitres' },
      { ingredientId: 'bok-choy', quantity: 200, unit: 'grams' },
      { ingredientId: 'sesame-seed', quantity: 10, unit: 'grams' },
    ],
  ...
  recipe({
    ...
    dietaryTags: ['halal', 'no-pork', 'no-seafood'],
    ingredients: [
      { ingredientId: 'yellow-noodles', quantity: 400, unit: 'grams' },
      { ingredientId: 'egg', quantity: 2, unit: 'pieces' },
      { ingredientId: 'chicken-breast', quantity: 200, unit: 'grams' },
      { ingredientId: 'tomato', quantity: 2, unit: 'pieces' },
      { ingredientId: 'bok-choy', quantity: 150, unit: 'grams' },
      { ingredientId: 'onion', quantity: 1, unit: 'pieces' },
      { ingredientId: 'garlic', quantity: 3, unit: 'cloves' },
      { ingredientId: 'curry-powder', quantity: 8, unit: 'grams' },
      { ingredientId: 'soy-sauce', quantity: 30, unit: 'millilitres' },
      { ingredientId: 'dark-soy-sauce', quantity: 15, unit: 'millilitres' },
      { ingredientId: 'cooking-oil', quantity: 30, unit: 'millilitres' },
    ],
    steps: ['Rinse the yellow noodles briefly and drain well.', 'Stir-fry chicken in half the oil until just cooked, then set aside.', 'Fry onion and garlic, then add curry powder and cook until fragrant.', 'Add tomato and bok choy; cook until the greens soften.', 'Add noodles, light soy sauce, dark soy sauce and chicken, tossing over high heat.', 'Push noodles aside, scramble the eggs, then fold everything together for a Malaysian mamak-style finish.'] }),
  recipe({
    id: 'chicken-porridge',
    ...
    dietaryTags: ['halal', 'no-pork', 'no-seafood'],
    ingredients: [
      { ingredientId: 'porridge-rice', quantity: 150, unit: 'grams' },
      { ingredientId: 'chicken-breast', quantity: 250, unit: 'grams' },
      { ingredientId: 'water', quantity: 1200, unit: 'millilitres' },
      { ingredientId: 'ginger', quantity: 20, unit: 'grams' },
      { ingredientId: 'garlic', quantity: 2, unit: 'cloves' },
      { ingredientId: 'spring-onion', quantity: 2, unit: 'stalks' },
      { ingredientId: 'soy-sauce', quantity: 20, unit: 'millilitres' },
      { ingredientId: 'salt', quantity: 5, unit: 'grams' },
      { ingredientId: 'pepper', quantity: 2, unit: 'grams' },
    ],
  ...
  recipe({
    ...
    ingredients: [
      { ingredientId: 'cooked-rice', quantity: 500, unit: 'grams' },
      { ingredientId: 'egg', quantity: 2, unit: 'pieces' },
      { ingredientId: 'carrot', quantity: 1, unit: 'pieces' },
      { ingredientId: 'green-beans', quantity: 120, unit: 'grams' },
      { ingredientId: 'bok-choy', quantity: 100, unit: 'grams' },
      { ingredientId: 'spring-onion', quantity: 2, unit: 'stalks' },
      { ingredientId: 'garlic', quantity: 2, unit: 'cloves' },
      { ingredientId: 'soy-sauce', quantity: 25, unit: 'millilitres' },
      { ingredientId: 'cooking-oil', quantity: 30, unit: 'millilitres' },
    ],
  ...
  recipe({
    id: 'roti-telur',
    name: 'Roti Telur',
    localName: 'Roti Telur',
    timeMinutes: 25,
    difficulty: 'medium',
    mealType: 'breakfast',
    dietaryTags: ['halal', 'vegetarian', 'no-pork', 'no-seafood'],
    ingredients: [
      { ingredientId: 'flour', quantity: 300, unit: 'grams' },
      { ingredientId: 'water', quantity: 170, unit: 'millilitres' },
      { ingredientId: 'egg', quantity: 3, unit: 'pieces' },
      { ingredientId: 'onion', quantity: 1, unit: 'pieces' },
      { ingredientId: 'cooking-oil', quantity: 60, unit: 'millilitres' },
      { ingredientId: 'salt', quantity: 5, unit: 'grams' },
    ],
...
const pantryItem = (ingredientId, quantity, overrides = {}) => {
...
export const defaultPantry = [
  pantryItem('cooked-rice', 500),
  pantryItem('egg', 6, { expiryDate: '2026-08-02' }),
  pantryItem('garlic', 6),
  pantryItem('soy-sauce', 250),
  pantryItem('cooking-oil', 500),
  pantryItem('onion', 3),
];
